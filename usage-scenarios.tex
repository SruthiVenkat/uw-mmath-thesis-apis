...
\item Cluster 1:
\begin{itemize}
\item com.alibaba.fastjson.annotation
\item com.alibaba.fastjson.asm
\item com.alibaba.fastjson.parser
\item com.alibaba.fastjson.serializer
\item com.alibaba.fastjson.support.hsf
\item com.alibaba.fastjson.support.config
\item com.alibaba.fastjson.support.retrofit
\item com.alibaba.fastjson.support.springfox
\end{itemize}
\item Cluster 2:
\begin{itemize}
\item com.alibaba.fastjson
\end{itemize}
\item Cluster 3:
\begin{itemize}
\item com.alibaba.fastjson.util
\item com.alibaba.fastjson.parser.deserializer
\end{itemize}
\item Cluster 4:
\begin{itemize}
\item com.alibaba.fastjson.support.spring
\item com.alibaba.fastjson.support.spring.annotation
\end{itemize}
\item Cluster 5:
\begin{itemize}
\item com.alibaba.fastjson.support.jaxrs
\end{itemize}
\end{enumerate}
