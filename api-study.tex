...
We observe only one use of library annotations across all our benchmarks. % crushpaper:crushpaper : com.fasterxml.jackson.databind.annotation.JacksonStdImpl
