...
\lstinputlisting[language=json,label=listing:input-format-1]{code-snippets/input-format-1.json}
...
\lstinputlisting[language=json,label=listing:input-format-2]{code-snippets/input-format-2.json}
\end{enumerate}
...
\lstinputlisting[language=json,label=listing:input-example]{code-snippets/input-example.json}
